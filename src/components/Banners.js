...
export const Banner4 =  ({FirstTitle, SecondTitle, Desc, ButtonT, onSectionClick}) => {
    ...
    return (
        <>
         <div className="w-full h-full grid grid-cols-4 grid-rows-4 gap-8" style={GRID_LG}>
            {/** LEFT SIDE */}
            <div className="border-2 border-amber-500" style={{ gridArea: "blank", ...BLANK_BORDER_L }}></div>
            <div className={`p-1 flex custom-box b3card-${theme} border-sky`} style={{ gridArea: "photo", 'background-image': "radial-gradient(var(--sky), var(--smblue), var(--blue))" }}>
            ...
            <div className={`p-4 flex flex-col gap-3 justify-center items-center custom-box bg-blue border-red`} style={{ gridArea: "figma" }}>
                ...
                <div className=" flex items-center gap-5 justify-between">
                    <button className="w-2/5 h-full p-2 text-xl font-semibold rounded-xl bg-sky">FIGMA</button>
            ...
            {/** RIGHT SIDE */}
            <div className="flex justify-center items-center relative" style={{gridArea: "quote"}}>
            ...
            <div className={`flex flex-col justify-center custom-box bg-blue border border-amber`} style={{ gridArea: "question" }}>
                <div className="px-5 mx-auto max-w-3xl flex flex-col gap-4 text-center">
                    <h1 className="bg-gradient-to-r from-blue-950 to-red-500 bg-clip-text font-bold font-calibre text-2xl text-transparent">
                        {FirstTitle}
