...
export default function Modal({open, children, close}) {
    ...
    return (
        ...
        <div style={MODAL_STYLE} className="drop-shadow text-justify">
            ...
            <a className="underline text-justify text-sky-500 cursor-pointer" href="https://drive.google.com/drive/folders/14YMTm57JBtQRZDtn9AsMu67C4BEYlPVv?usp=sharing" target="_blank"> If you afraid, you could click this link to download it through the gdrive link</a></p>
